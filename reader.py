...
for i in range(len(images)):
    ...
    with open("page"+str(i)+".jpg", "r") as file:
        ...
        table = table.replace("Record of employees' 2023 salaries and benefits", "")
        table = table.replace("Registre des traitements et avantages verses aux employes en 2023", "")
        print(table)
